...
%pandaArms.xdot.alt=[0;0;0;pandaArms.ArmL.xdot.alt ;0;0;0;pandaArms.ArmR.xdot.alt];
...
switch mission.phase
    case 1
        ...
        % Tool position and orientation task reference
         ...
         pandaArms.ArmL.xdot.tool(1:3) = 0.2*ang;
        pandaArms.ArmL.xdot.tool(4:6) = 0.2*lin;
        
        % limit the requested velocities...
        pandaArms.ArmL.xdot.tool(1:3) = Saturate(pandaArms.ArmL.xdot.tool(1:3),1);
        pandaArms.ArmL.xdot.tool(4:6) = Saturate(pandaArms.ArmL.xdot.tool(4:6),1);
        ...
        pandaArms.ArmR.xdot.tool(1:3) = 0.2*ang;
        pandaArms.ArmR.xdot.tool(4:6) = 0.2*lin;
        % limit the requested velocities...
        pandaArms.ArmR.xdot.tool(1:3) = Saturate(pandaArms.ArmR.xdot.tool(1:3),1);
        pandaArms.ArmR.xdot.tool(4:6) = Saturate(pandaArms.ArmR.xdot.tool(4:6),1);

        pandaArms.xdot.tool=[pandaArms.ArmL.xdot.tool ;pandaArms.ArmR.xdot.tool];
    case 2
